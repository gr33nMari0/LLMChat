// src/main/java/com/petepeterepeat/LLMChat/model/ApiResponse.java

package com.petepeterepeat.LLMChat.model;
...
public class ApiResponse {
    ...
    public void setSample_duration(long sample_duration) {
